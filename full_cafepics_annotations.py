#!/usr/bin/env python3
"""
Complete OCR Training Data Annotations for ALL 35 cafe pics
...
FULL_CAFE_ANNOTATIONS = {
    # Previously annotated images from complete_cafepics_annotations.py
    "copper1.png": {
    ...
    # New annotations from additional images
    "Screenshot 2025-07-10 083019.png": {
        ...
        "orders": [
            ...
            {"fish": "Esmark's eelpout", "quantity": "1", "mass": "2.899 kg", "price": "1,940.24"}
        ]
    },
    ...
    "Screenshot 2025-07-10 083116.png": {
        ...
        "orders": [
            ...
            {"fish": "Atlantic redfish", "quantity": "1", "mass": "5.399 kg", "price": "2,667.49"}
        ]
    },
    ...
    "Screenshot 2025-07-10 083421.png": {
        ...
        "orders": [
            ...
            {"fish": "Atlantic redfish", "quantity": "1", "mass": "5.399 kg", "price": "2,901.54"}
        ]
    },
    ...
    "norway5.png": {
        ...
        "orders": [
            ...
            {"fish": "Turbot", "quantity": "1", "mass": "14 kg", "price": "1,031.59"}
        ]
    },
    "norway6.png": {
        "location": "Norwegian Sea",
        "orders": [
            ...
            {"fish": "Atlantic redfish", "quantity": "1", "mass": "2.899 kg", "price": "1,451.15"}
        ]
    }
}
...
def create_full_training_dataset(cafepics_dir="cafepics", output_dir="ocr_training_full"):
    """Create complete training dataset from all 35 annotations"""
    os.makedirs(output_dir, exist_ok=True)
    
    # Copy original test images if they exist
    for img in ["copper1.png", "norway1.png", "norway2.png", "norway4.png", "norway5.png", "norway6.png"]:
    ...
    successful = 0
    for image_name, annotation in FULL_CAFE_ANNOTATIONS.items():
    ...
    with open(manifest_file, 'w') as f:
        for image_name in FULL_CAFE_ANNOTATIONS.keys():
            base_name = os.path.splitext(image_name)[0]
            f.write(f"{base_name}\n")
    
    # Create comprehensive vocabulary file
    vocab_file = os.path.join(output_dir, "rf4_vocabulary.txt")
    vocab = set()
    
    # Extract all unique words
    for annotation in FULL_CAFE_ANNOTATIONS.values():
