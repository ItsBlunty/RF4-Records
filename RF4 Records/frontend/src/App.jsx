    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="fixed top-6 right-6 z-50">
        <button
          ...
          className="group relative flex items-center justify-center w-16 h-10 bg-blue-500 dark:bg-blue-600 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 border-2 border-white"
          title={darkMode ? 'Switch to light mode' : 'Switch to dark mode'}
        >
          {/* Toggle Track */}
          <div className="absolute inset-0 rounded-full bg-blue-500 dark:bg-blue-600 transition-colors duration-300"></div>
          
          {/* Toggle Circle */}
          <div className={`absolute w-8 h-8 bg-white dark:bg-gray-800 rounded-full shadow-md transform transition-all duration-300 flex items-center justify-center ${
